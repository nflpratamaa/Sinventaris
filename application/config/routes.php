...
$route['pengembalian'] = 'pengembalian/index'; // Menampilkan halaman pengembalian
$route['pengembalian/kembalikan/(:num)'] = 'pengembalian/kembalikan/$1'; // Mengubah status peminjaman
